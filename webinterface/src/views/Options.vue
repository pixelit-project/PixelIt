            ...
            <v-row>
                ...
                <v-col cols="12" lg="3">
                    <v-card class="pa-2" elevation="4">
                        ...
                        <v-text-field v-model="config.clockAutoFallbackTime" type="number" label="Clock auto fallback time" hint="the unit is seconds (s)" suffix="seconds" :disabled="!config.clockAutoFallbackActive" :rules="config.clockSwitchAktiv ? [rules.required, rules.min0] : []"></v-text-field>
                    </v-card>
                </v-col>
                <v-col cols="12" lg="3">
                    <v-card class="pa-1" elevation="4">
                        ...
                        <v-text-field v-model="config.scrollTextDefaultDelay" type="number" label="Scrolltext belay" hint="larger number is slower" suffix="milliseconds" :rules="[rules.required, rules.min0]"></v-text-field>
                    </v-card>
                    <br />
                    <v-card class="pa-2" elevation="4">
                        <v-card-title>
